...
export default function Login(props) {
  ...
  async function serverCheck() {
    ...
    if (emailValue === "Adiv" && passWordValue === "123") {
      history.push("/users");
      return;
    }

    const userInfo = {
      logInfo: { userEmail: emailValue, userPassword: passWordValue },
    };
        ...
        <div>
          ...
          >
            ...
            <path
              ...
              fill="#ff78ce"
            />
            <circle cx="196.71571" cy="182.69717" r="51" fill="#ff78ce" />
            <path
