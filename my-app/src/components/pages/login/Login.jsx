...
import { getAllUsers, getSpecifideUser } from '../../../service/apiMyServer'
...
export default function Login() {
  ...
  const [visible, setVisible] = useState(false);
   ...
   await getSpecifideUser(userInfo).then((res)=> {console.log(res.success);setUserLog(res.success); return res.success})
      ...
      <InputAdornment position="end">
       <IconButton onClick={toggleVisibility}>
        {visible ? <Visibility /> : <VisibilityOff/>}
                ...
                <Button id="buttonComponentInLogin" variant="contained" size="small" onClick={serverCheck }>login</Button>
            </div>
            </div>
